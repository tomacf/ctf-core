...
mysql = MySQL()
app = Flask(__name__)
app.config['MYSQL_DATABASE_USER'] = 'strange_dragon'
app.config['MYSQL_DATABASE_PASSWORD'] = 'how_d0_you_turn_THIS_on'
app.config['MYSQL_DATABASE_DB'] = 'unit_cyber_db'
...
if __name__ == "__main__":
	...
	if(sys.argv[1]=='test'):
		app.run(host='0.0.0.0',port=3580,debug=True)
	else:
		PORT = 40003
		print '------------------------'
